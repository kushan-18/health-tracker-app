          ...
          <div className="flex flex-col sm:flex-row gap-6">
            <div className="flex flex-col items-center gap-2 flex-shrink-0">
              <div className="relative">
                <CircularProgress value={totalCalories} max={targetCalories} size={130} strokeWidth={8} showLabel={false} />
                <div className="absolute inset-0 flex flex-col items-center justify-center">
      ...
      <Card className={cn(CARD_HOVER, 'h-full relative overflow-hidden')}>
        ...
        <CardContent className="relative">
          <div className="flex items-center gap-4 mb-4">
            <div className="relative">
              <CircularProgress value={85} size={80} strokeWidth={6} showLabel={false} />
